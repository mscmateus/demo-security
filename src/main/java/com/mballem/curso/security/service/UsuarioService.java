...
public class UsuarioService implements UserDetailsService{
	...
	@Transactional(readOnly = false) 
	public void alterarSenha(Usuario usuario, String senha) throws MessagingException {
...
//		emailService.enviarPedidoDeConfirmacaoDeCadastro(email, codigo);
	...
	public void pedidoRedefinicaoDeSenha(String email) throws MessagingException {
		Usuario usuario = buscaPorEmailEAtivo(email).orElseThrow(() -> new UsernameNotFoundException("Usuário "+email+" não encontrado!"));
